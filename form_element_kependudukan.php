			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						...
						<?php } ?>
										...
										<div class="col-md-12">
											<section class="panel">
												...
												<div class="panel-body">
													<div class="form-group">
														 <h4 class="panel-title">A. Pendidikan Terakhir & Pekerjaan</h4><hr>
														<table id="tb_anggota" class="table">
															<thead>
																<tr>
																	<th>NIK</th>
						...
						<td><center><select name="pendidikan" id="" class="form-control">
						...
						<td><center><select name="pekerjaan" id="" class="form-control">
															...
															<td><center><select name="dasar1" id="" class="form-control">
																<option value="">Pilih</option>
																<option value="Surat">Surat</option>
																<option value="Akta">Akta</option>
																<option value="Ijazah">Ijazah</option>
						...
						<?php } ?>
														...
														<h4 class="panel-title">B. Agama & Perubahan Lainnya</h4><hr>
														<table id="tb_anggota" class="table">
															<thead>
																<tr>
																	<th>NIK</th>
																	...
																	<th>Agama (Menjadi)</th>
																	<th>Dasar Perubahan</th>
																	<th>Lainnya (Semula)</th>
																	<th>Lainnya (Menjadi)</th>
																	<th>Dasar Perubahan</th>
																</tr>
															</thead>
															<tbody>
															<?php
						$qw=mysqli_query($connect,"SELECT * FROM biodata_wni,data_keluarga,agama 
						...
						<td><center><?php echo $cw['NIK'];?></center></td>
						<td><center><?php echo $cw['NAMA_LGKP'];?></center></td>
						<td><center><?php echo $cw['nama_agama'];?></center></td>
						<td><center><select name="agama" id="" class="form-control">
																<option value="">Pilih</option>
																<?php
						...
						<td><center><input type="text" required="required" placeholder="isi disini" class="form-control" name="lainnya" id="" value=""></center></td>
					<td><center><input type="text" required="required" placeholder="isi disini" class="form-control" name="lainnya" id="" value=""></center></td>
															<td><center><select name="dasar1" id="" class="form-control">
																<option value="">Pilih</option>
																<option value="Surat">Surat</option>
