											...
											<section class="panel">
												...
												<div class="panel-body">
													...
													<div class="form-group">
														...
														<div class="col-md-3">
															<input type="text" class="form-control" placeholder="Depan" required="required" name="alamat" id="alamat" value="">
														</div>
														<div class="col-md-3">
															<input type="text" class="form-control" placeholder="Belakang" required="required" name="alamat" id="alamat" value="">
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<p style="padding: 5px;" class="col-md-3">
															<input type="checkbox" name="berkas[]" id="ktp" value="ktp" data-parsley-mincheck="2" class="flat" /> Laki-laki
														</p>
														<p style="padding: 5px;" class="col-md-3">
															<input type="checkbox" name="berkas[]" id="kk" value="kk" class="flat" /> Perempuan
														</p>
															</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-6">
															<input type="text" class="form-control" placeholder="Tempat Lahir" required="required" name="alamat" id="alamat" value="">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-2">
															<input type="text" class="form-control" placeholder="Tgl" required="required" name="alamat" id="alamat" value="">
														</div>
														<div class="col-md-2">
															<input type="text" class="form-control" placeholder="Bln" required="required" name="alamat" id="alamat" value="">
														</div>
														<div class="col-md-2">
															<input type="text" class="form-control" placeholder="Thn" required="required" name="alamat" id="alamat" value="">
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-md-6">
														<p style="padding: 5px;" class="col-md-3">
															<input type="checkbox" name="berkas[]" id="ktp" value="ktp" data-parsley-mincheck="2" class="flat" /> Kawin
														</p>
														<p style="padding: 5px;" class="col-md-3">
															<input type="checkbox" name="berkas[]" id="kk" value="kk" class="flat" /> Belum Kawin
														</p>
															</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-md-6">
														<p style="padding: 5px;" class="col-md-3">
															<input type="radio" name="berkas[]" id="ktp" value="ktp" data-parsley-mincheck="2" class="flat" /> SD
														</p>
														<p style="padding: 5px;" class="col-md-3">
															<input type="radio" name="berkas[]" id="kk" value="kk" class="flat" /> SMP
														</p>
														<p style="padding: 5px;" class="col-md-3">
															<input type="radio" name="berkas[]" id="kk" value="kk" class="flat" /> SMA/SMK
														</p>
														<p style="padding: 5px;" class="col-md-3">
															<input type="radio" name="berkas[]" id="kk" value="kk" class="flat" /> S1
														</p>
														<p style="padding: 5px;" class="col-md-3">
															<input type="radio" name="berkas[]" id="kk" value="kk" class="flat" /> S2
														</p>
														<p style="padding: 5px;" class="col-md-3">
															<input type="radio" name="berkas[]" id="kk" value="kk" class="flat" /> S3
														</p>
