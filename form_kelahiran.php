											...
											<div class="panel-body">
												<div class="form-group">
													...
													<p style="padding: 5px;" class="col-md-3">
														<input type="checkbox" name="berkas[]" id="ktp_ayah" value="ktp_ayah" data-parsley-mincheck="2" class="flat" /> KTP AYAH
														<br />
														<input type="checkbox" name="berkas[]" id="ktp_ibu" value="ktp_ibu" class="flat" /> KTP IBU
														<br />
														<input type="checkbox" name="berkas[]" id="ktp_pemohon" value="ktp_pemohon" class="flat" /> KTP PEMOHON
														<br />
														<input type="checkbox" name="berkas[]" id="ktp_saksi1" value="ktp_saksi1" class="flat" /> KTP SAKSI I
														<br />
													</p>
													<p style="padding: 5px;" class="col-md-3">
														<input type="checkbox" name="berkas[]" id="ktp_saksi2" value="ktp_saksi2" class="flat" /> KTP SAKSI II
														<br />
														<input type="checkbox" name="berkas[]" id="sk_rs" value="sk_rs" class="flat" /> SK RUMAH SAKIT
														<br />
