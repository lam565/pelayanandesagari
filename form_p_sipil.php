						...
						<div class="col-lg-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Form Pencatatan Sipil Di Dalam Wilayah NKRI</h2>
								</header>
								<div class="panel-body">
									<form class="form-horizontal form-bordered" action="simpan_pindah.php" method="POST" enctype="multipart/form-data">
										...
										<div class="col-md-12">
											<section class="panel">
												<header class="panel-heading">
													<h2 align="center" class="panel-title">Pilih Salah Satu :</h2>
												</header><br>
										...
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h5 class="title">Kelahiran</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_sipil_kelahiran.php">Input Data</a>
													</div>
												</div>
											</div>
										</div>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Lahir Mati</h4>
														<p></p>
													</div>
													<div class="summary-footer">
														<a  href="form_sipil_lahirmati.php">Input Data</a>
													</div>
												</div>
											</div>
										</div>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Perkawinan / Pembatalan Perkawinan</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_k_wniln.php">Input Data</a>
													</div>
												</div>
											</div>
										</div>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Perceraian / Pembatalan Perceraian</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_sipil_cerai.php">Input Data</a>
													</div>
												</div>
											</div>
										</div>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Kematian</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_sipil_kematian.php">Input Data</a>
													</div>
												</div>
											</div>
										</div>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Pengangkatan Anak</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_sipil_angkatanak.php">Input Data</a>
													</div>
												</div>
											</div>
										</div>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Pengakuan Anak</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_k_wniln.php">Input Data</a>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Pengesahan Anak</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_k_wniln.php">Input Data</a>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Perubahan Nama</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_k_wniln.php">Input Data</a>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Perubahan Status Kewarganegaraan</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_k_wniln.php">Input Data</a>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Pencatatan Peristiwa Penting Lainnya</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_k_wniln.php">Input Data</a>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Pembetulan Akta</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_k_wniln.php">Input Data</a>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Pembatalan Akta</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_k_wniln.php">Input Data</a>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Pelaporan Pencatatan Sipil Dari Luar Wilayah NKRI </h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_k_wniln.php">Input Data</a>
