						...
						<div class="col-lg-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Form Perceraian / Pembatalan Perceraian</h2>
								</header>
								<div class="panel-body">
									...
									<div class="col-md-12">
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Data Subjek Akta KeSatu :</h2>
											</header>
											<div class="panel-body">
												<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">NIK Pelapor</label>
									...
									<div class="col-md-12">
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Data Subjek Akta KeDua (Jika Ada) :</h2>
											</header>
											<div class="panel-body">
												<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">NIK Pelapor</label>
									...
									<div class="col-md-12">
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Yang Mengajukan Perceraian / Pembatalan Perceraian :</h2>
											</header>
											<div class="panel-body">
												...
												<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">Tanggal Akta Perkawinan</label>
													<div class="col-md-6">
														<input type="date" required="required"  class="form-control" name="tgl_lhr" id="tgl_lhr" value="">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">Tempat Pencatatan Perkawinan</label>
													<div class="col-md-6">
														<input type="text" required="required" placeholder="Tempat Lahir" class="form-control" name="tmp_lahir" id="tmp_lahir" value="">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">Tanggal Putusan Pengadilan</label>
													<div class="col-md-6">
														<input type="date" required="required"  class="form-control" name="tgl_lhr" id="tgl_lhr" value="">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">Nomor Putusan Pengadilan</label>
													<div class="col-md-6">
														<input type="text" required="required" placeholder="Tempat Lahir" class="form-control" name="tmp_lahir" id="tmp_lahir" value="">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">Nomor Surat Keterangan Panitera Pengadilan</label>
													<div class="col-md-6">
														<input type="text" required="required" placeholder="Tempat Lahir" class="form-control" name="tmp_lahir" id="tmp_lahir" value="">
													</div>
												</div>
													<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">Tanggal Surat Keterangan Panitera Pengadilan</label>
													<div class="col-md-6">
														<input type="text" required="required" placeholder="Tempat Lahir" class="form-control" name="tmp_lahir" id="tmp_lahir" value="">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-6">
														<input type="date" required="required" placeholder="Tempat Lahir" class="form-control" name="tmp_lahir" id="tmp_lahir" value="">
													</div>
												</div>
									...
									<div class="col-md-12">
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Bagi Pemohon Pembatalan Perceraian Harap Mengisi Data Di Bawah Ini  :</h2>
											</header>
											<div class="panel-body">
											
												<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">Nomor Akta Perceraian</label>
													<div class="col-md-6">
														<input type="text" required="required" placeholder="Tempat Lahir" class="form-control" name="tmp_lahir" id="tmp_lahir" value="">
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">Tanggal Akta Perceraian</label>
													<div class="col-md-6">
														<input type="date" required="required"  class="form-control" name="tgl_lhr" id="tgl_lhr" value="">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">Tanggal Pelaporan Perceraian Dari Luar Negeri</label>
													<div class="col-md-6">
														<input type="date" required="required" placeholder="Tempat Lahir" class="form-control" name="tmp_lahir" id="tmp_lahir" value="">
													</div>
												</div>
