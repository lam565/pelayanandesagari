				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
						...
						<div class="col-md-6">
								...
								<section class="panel">
									...
									<div class="">
											...
											<label class="col-md-3 control-label" for="inputDefault">Tanggal Lahir</label>
												<div class="col-md-9">
													<input type="text" required="required" class="form-control" name="TGL_LHR1" id="TGL_LHR1" >
												</div>
												</div><br><br>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Pekerjaan</label>
												<div class="col-md-9">
													<input type="text" required="required" class="form-control" name="pekerjaan1" id="pekerjaan1" value="">
												</div><br><br>
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Alamat</label>
												<div class="col-md-9">
													<input type="text" required="required" class="form-control" name="ALAMAT1" id="ALAMAT1" value="">
												</div><br><br>
											</div>
									</div>
								...
								<section class="panel">
									...
									<div class="">
											...
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Pekerjaan</label>
												<div class="col-md-9">
													<input type="text"  class="form-control" name="pekerjaan2" id="pekerjaan2" value="">
												</div><br><br>
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Alamat</label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="ALAMAT2" id="ALAMAT2" value="">
												</div><br><br>
											</div>
									</div>
								...
								<section class="panel">
									...
									<div class="">
											...
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Pekerjaan</label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="pekerjaan3" id="pekerjaan3" value="">
												</div><br><br>
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Alamat</label>
												<div class="col-md-9">
													<input type="text"  class="form-control" name="ALAMAT3" id="ALAMAT3" value="">
												</div><br><br>
											</div>
									</div>
						...
						<p>==============================================================================================================================================</p>
								...
								<section class="panel">
									...
									<div class="">
											...
											<label class="col-md-3 control-label" for="inputDefault">Tanggal Lahir</label>
												<div class="col-md-9">
													<input type="text" required="required" class="form-control" name="TGL_LHR7" id="TGL_LHR7" >
												</div>
												</div><br><br>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Pekerjaan</label>
												<div class="col-md-9">
													<input type="text" required="required" class="form-control" name="pekerjaan7" id="pekerjaan7" value="">
												</div><br><br>
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Alamat</label>
												<div class="col-md-9">
													<input type="text" required="required" class="form-control" name="ALAMAT7" id="ALAMAT7" value="">
												</div><br><br>
											</div>
									</div>
								...
								<section class="panel">
									...
									<div class="">
											...
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Alamat</label>
												<div class="col-md-9">
													<input type="text" required="required" class="form-control" name="ALAMAT8" id="ALAMAT8" value="">
												</div><br><br>
											</div>
									</div>
						...
						<div class="">
												...
												<div class="col-md-6">
											<input type="checkbox" class="flat" name="ktp1" value="KTP1"> KTP Pelapor<br>
                                             <input type="checkbox" class="flat" name="ktp1" value="KTP1"> KTP Saksi 1<br>
											
                                             <input type="checkbox" class="flat" name="ktp2" value="KTP2"> KTP Saksi 2<br>
											 <input type="checkbox" class="flat" name="ktp1" value="KTP1"> Surat Keterangan Kematian Kalurahan/RS/Polisi<br>
											 <input type="checkbox" class="flat" name="ktp1" value="KTP1"> Buku Nikah/Keterangan Kalurahan<br>
											 <input type="checkbox" class="flat" name="ktp1" value="KTP1"> Kuasa<br>
											 
											 <input type="checkbox" class="flat" name="kk" value="KTP2"> Kartu Keluarga<br>
